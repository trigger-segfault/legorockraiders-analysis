...
BOOL __cdecl lego::ai::AITask_LiveObject_Callback_DoAITask(LegoObject *liveObj,float *pElapsedGame);
...
void __cdecl lego::front::Bubble_LiveObject_GetBubbleImage_FUN_004077f0(LegoObject *liveObj,float elapsedAbs,Image **out_bubbleImage,Point2F *out_screenPt);
BOOL __cdecl lego::front::Bubble_LiveObject_CallbackDraw_FUN_00407890(LegoObject *liveObj,float *pElapsedAbs);
...
BOOL __cdecl lego::game::Dependencies_Object_FUN_0040add0(LegoObject_Type objType,int objID,int objLevel);
...
MenuItem_SelectData * __cdecl lego::front::Front_MenuItem_CreateSelect(int *valuePtr,char *string1,char *string2,int x1,int y1,int width1,int height1,int x2,int y2,int width2,int height2,int field50,MenuItem_SelectCallback callback,Menu *opt_nextMenu);
...
int __cdecl lego::front::Front_MenuItem_Select_CollisionCheck_FUN_00411290(Menu *menu,MenuItem *menuItem,MenuItem_SelectData *selectData);
...
uint __cdecl lego::front::Front_Input_GetKeyCharacter(Keys diKey);
...
Menu * __cdecl lego::front::Front_Menu_Update(float elapsed,Menu *menu,BOOL *optout_bool);
...
void __cdecl lego::front::Front_LoadMenuTextWindow(Config *config,char *gameName,MenuTextWindow *menuWnd);
...
void __cdecl lego::front::MainMenuFull_AddMissionsDisplay(int valueOffset,LevelLink *startLink,LevelSet *levelSet,Menu *menu,SaveData *saveData,Menu *opt_menu58,void *callback);
BOOL __cdecl lego::save::Front_Save_ReadSaveFile(uint saveIndex,SaveData *out_saveData,BOOL readOnly);
BOOL __cdecl lego::save::Front_Save_WriteSaveFiles(uint saveNumber,SaveData *opt_saveData);
...
BOOL __cdecl lego::front::Front_Save_GetBool_540(void);
void __cdecl lego::front::Front_Save_SetBool_540(BOOL state);
void __cdecl lego::front::Front_Save_Write_FUN_00417f30(void);
...
void __cdecl lego::front::Front_Save_SetBool_85c(BOOL state);
BOOL __cdecl lego::front::Front_Save_FUN_00418050(void);
...
BOOL __cdecl lego::front::Interface_GetMenuItemType(char *menuItemName,Interface_MenuItem *out_menuItemType);
...
void __cdecl lego::front::Interface_OpenMenu_FUN_0041b200(Interface_MenuType menuType,Point2I *blockPos);
void __cdecl lego::front::Interface_SelectBlock(Interface_MenuType menuType,Point2I *blockPos);
...
void __cdecl lego::front::Interface_FUN_0041c420(Interface_MenuItem menuIcon,LegoObject_Type objType,int objID,float *param_4);
BOOL __cdecl lego::front::Interface_FUN_0041c610(Interface_MenuItem menuIcon,int param_2,int param_3,BOOL param_4,BOOL param_5);
...
BOOL __cdecl lego::front::Interface_HandleMenuItem(Interface_MenuItem menuIcon);
...
BOOL __cdecl lego::front::Interface_GetObjectBool_FUN_0041e8c0(LegoObject_Type objType,int objID);
void __cdecl lego::front::Interface_SetScrollParameters(uint xEnd,uint yEnd,uint xStart,uint yStart,float timerFloat_750);
void __cdecl lego::front::Interface_UnkSlideOffScreen_FUN_0041e980_internal(Interface_MenuType menuType,Point2I *opt_blockPos);
...
BOOL __cdecl lego::front::Interface_HasTeleporterForObject(LegoObject_Type objType,int objID);
...
BOOL __cdecl lego::front::Interface_HasObjectOfTypeID(LegoObject_Type objType,int objID);
BOOL __cdecl lego::front::Interface_HasObjectWithAbilities(LiveFlags5 abilityFlags);
...
BOOL __cdecl lego::front::Interface_CheckPrimaryUnitHasAbility(LiveFlags5 abilityFlag);
...
void __cdecl lego::game::Lego_SetFlag1_20000_unkCameraRadarHasTrackObj(BOOL state);
...
void __cdecl lego::lrr::Lego_StartLevelEnding(void);
...
void __cdecl lego::game::Lego_UpdateSceneFog(BOOL isFogEnabled,float elapsed);
BOOL __cdecl lego::game::LiveObject_Callback_DrawRedBox_IfFlags4_1(LegoObject *liveObj,Viewport *viewMain);
BOOL __cdecl lego::game::Lego_DrawRedBoxes_AroundUnitsWithFlags4_1(Viewport *viewMain);
void __cdecl lego::game::Lego_DrawSelectedUnitBoxes(Viewport *viewMain);
...
BOOL __cdecl lego::lrr::Lego_HandleKeys(float elapsedGame,float param_2,BOOL *out_keyDownT,BOOL *out_keyDownR,BOOL *out_keyDownAnyShift);
...
void __cdecl lego::game::Lego_SetPaused(BOOL checkCamDisableFlag,BOOL paused);
void __cdecl lego::game::Lego_LockGameSpeed(BOOL locked);
void __cdecl lego::game::Lego_SetGameSpeed(float newGameSpeed);
void __cdecl lego::game::Lego_TrackObjectInRadar(LegoObject *liveObj);
BOOL __cdecl lego::game::Lego_IsFirstPersonView(void);
...
void __cdecl lego::game::Lego_GetVector_45c(Vector3F *out_vector);
void __cdecl lego::lrr::Lego_UnkCameraTrack_InRadar_FUN_00426180(void);
void __cdecl lego::game::Lego_SetMenuNextPosition(Point2F *position);
void __cdecl lego::game::Lego_SetMenuPreviousPosition(Point2F *position);
void __cdecl lego::game::Lego_SetFlags2_40_And_2_unkCamera(BOOL onFlag40,BOOL onFlag2);
void __cdecl lego::game::Lego_SetFlags2_80(BOOL state);
void __cdecl lego::lrr::Lego_UnkObjective_CompleteSub_FUN_004262f0(void);
void __cdecl lego::game::Lego_UpdateTopdownCamera(float elapsedAbs);
void __cdecl lego::game::Lego_unkGameLoop_FUN_00426450(float elapsedGame,float elapsedAbs,BOOL keyDownT,BOOL keyDownR,BOOL keyDownAnyShift);
...
void __cdecl lego::game::Lego_SetPointerSFX(PointerSFX_Type pointerSFXType);
void __cdecl lego::lrr::Lego_HandleDebugKeys(int bx,int by,LegoObject *liveObj,float gameCtrlElapsed);
...
void __cdecl lego::game::Lego_MainView_MouseTransform(uint mouseX,uint mouseY,float *out_xPos,float *out_yPos);
...
void __cdecl lego::game::Lego_UpdateFallins(float elapsedGame);
BOOL __cdecl lego::lrr::Lego_LoadBlockPointersMap(Lego_Level *level,char *filename,int modifier);
Upgrade_PartModel * __cdecl lego::game::Lego_GetUpgradePartModel(char *upgradeName);
...
void __cdecl lego::game::Lego_RemoveRecordObject(LegoObject *liveObj);
BOOL __cdecl lego::game::Lego_GetRecordObject(uint recordObjPtr,LegoObject **out_liveObj);
BOOL __cdecl lego::game::Lego_LoadOLObjectList(Lego_Level *level,char *filename);
...
void __cdecl lego::game::Lego_PTL_RockFall(uint bx,uint by,int param_3,BOOL param_4);
...
void __cdecl lego::game::Lego_UpdateLevelBlocks_PointsAAC(void);
void __cdecl lego::game::Lego_LevelClearBlockFlag2_100_Points28C(void);
...
void __cdecl lego::game::Lego_UnkProcessBlockPtsTable_UnsetsFlag2_2(void);
...
BOOL __cdecl lego::game::Level_Block_IsSolidBuilding(uint bx,uint by,BOOL nonsolidToolStore);
...
BOOL __cdecl lego::game::LiveObject_GetDamageFromSurface(LegoObject *liveObj,int bx,int by,float elapsedGame,float *optout_damage);
...
void __cdecl lego::lrr::Lego_ClearSomeFlags3_FUN_00435950(void);
...
void __cdecl lego::game::LegoObject_InitGlobalFlagsToggle_AndClearNumDrained(void);
...
BOOL __cdecl lego::game::LegoObject_Callback_Update(LegoObject *in_liveObj,float *lpElapsed);
...
BOOL __cdecl lego::game::LegoObject_Route_AllocPtr_FUN_004419c0(LegoObject *liveObj,uint count,float *param_3,float *param_4,float *param_5);
void __cdecl lego::game::LegoObject_Route_UnkDoRouting_FUN_00441c00(LegoObject *liveObj,BOOL param_2);
...
void __cdecl lego::game::LegoObject_GetWeaponUnk(LegoObject *liveObj,WeaponKnownType weaponType);
...
void __cdecl lego::game::LegoObject_FUN_004459a0(LegoObject *liveObj,float elapsed);
BOOL __cdecl lego::game::LegoObject_Callback_FUN_00445a30(LegoObject *liveObj,LegoObject *otherObj);
BOOL __cdecl lego::game::LegoObject_Callback_FUN_00445af0(LegoObject *liveObj,LegoObject *otherObj);
...
BOOL __cdecl lego::game::LegoObject_UnkBuildingPlaceDirection(LegoObject_Type objType,int objID,BOOL param_3,BOOL param_4,Point2F *mouseWorldPos,uint mouseBlockX,uint mouseBlockY,BOOL param_8,SelectPlace *selectPlace);
...
void __cdecl lego::math::LegoObject_FlocksMatrix_FUN_0044ba60(Container *resData,Matrix4F *ref_matrix,float scalar);
...
BOOL __cdecl lego::nerps::NERPs_LiveObject_Callback_CountRecordObjectsAtBlock(BlockPointer *blockPointer,int bx,int by,SearchCountRecordObjects_8 *search);
...
int __cdecl lego::nerps::NERPs_GetIconClicked(Interface_MenuItem *pMenuIcon);
...
BOOL __cdecl lego::nerps::NERPs_LiveObject_Callback_SetRockMonsterHealthType(LegoObject *liveObj,SearchSetObjectHealthPain_c *search);
...
void __cdecl lego::game::Objective_SetConstructionObjective(Lego_Level *level,LegoObject_Type objType,int objID);
BOOL __cdecl lego::game::Objective_IsObjectiveAchieved(void);
void __cdecl lego::game::Objective_SetEndTeleportEnabled(BOOL on);
void __cdecl lego::game::Objective_SetStatus(ObjectiveStatus status);
void __cdecl lego::game::Objective_ProgrammerModeGT3_FUN_00458ba0(void);
BOOL __cdecl lego::game::Objective_IsEnded(void);
...
BOOL __cdecl lego::game::Objective_CheckCompleted(Lego_Level *level,BOOL *out_timerFailed,float elapsed);
BOOL __cdecl lego::game::Objective_Callback_CountObjects(LegoObject *liveObj,ObjectiveData *objective);
...
int __cdecl lego::snd::SFX_Random_Play_OrAddToQueue(SFX_ID sfxID,BOOL loop);
...
int __cdecl lego::gfx::SFX_Container_Random_Play_OrInitSoundUnk(Container *cont,SFX_ID sfxID,BOOL loop,BOOL sound3D,Vector3F *opt_position);
int __cdecl lego::snd::SFX_Random_Play_OrInitSoundUnk(IDirect3DRMFrame3 *frame,SFX_ID sfxID,BOOL loop,BOOL sound3D,Vector3F *opt_position);
...
uint __cdecl lego::stats::Stats_GetCostOre(LegoObject_Type objType,int objID,uint objLevel);
uint __cdecl lego::stats::Stats_GetCostCrystal(LegoObject_Type objType,int objID,uint objLevel);
uint __cdecl lego::stats::Stats_GetCostRefinedOre(LegoObject_Type objType,int objID,uint objLevel);
...
uint __cdecl lego::stats::Stats_GetLevels(LegoObject_Type objType,int objID);
uint __cdecl lego::stats::Stats_GetWaterEntrances(LegoObject_Type objType,int objIndex,int objLevel);
...
uint __cdecl lego::stats::Stats_GetUpgradeCostOre(LegoObject_Type objType,int objID,LegoObject_UpgradeType upgradeType);
uint __cdecl lego::stats::Stats_GetUpgradeCostStuds(LegoObject_Type objType,int objID,LegoObject_UpgradeType upgradeType);
...
void __cdecl lego::front::Text_SetNERPsMessage(char *text,BOOL unkFlags);
...
void __cdecl lego::tools::Weapon_LegoObject_FUN_0046f640(LegoObject *liveObj,float damage,BOOL param_3);
...
BOOL __cdecl lego::gfx::Mesh_SetGroupColour(Mesh *mesh,D3DRMGroupIndex groupID,float r,float g,float b,Mesh_Colour matType);
