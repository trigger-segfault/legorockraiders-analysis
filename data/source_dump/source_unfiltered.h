...
void __cdecl lego::ai::AITask_RemoveObject48References(LegoObject *obj48);
...
void __cdecl lego::lrr::Lego_HandleRenameInput(void);
...
BOOL __cdecl lego::lrr::Lego_DrawObjectLaserTrackerBox(LegoObject *liveObj,Viewport *viewMain);
...
void __cdecl lego::lrr::Lego_HandleWorld(float elapsedGame,float elapsedAbs,BOOL keyDownT,BOOL keyDownR,BOOL keyDownAnyShift);
...
void __cdecl lego::game::Level_PowerGrid_UpdateLevelBlocks_PointsAAC(void);
void __cdecl lego::game::Level_PowerGrid_ClearBlockPowered_100_Points28C(void);
...
void __cdecl lego::game::Legel_PowerGrid_ClearDrainPowerBlocks(void);
...
uint __cdecl lego::game::LegoObject_GetLevelObjectsBuilt(LegoObject_Type objType,LegoObject_ID objID,uint objLevel,BOOL currentLevel);
...
LegoObject * __cdecl lego::game::LegoObject_FUN_0043a910(LegoObject *liveObj,LegoObject_Type objType,LegoObject_ID objID,uint objLevel);
...
WeaponKnownType __cdecl lego::game::LegoObject_GetEquippedBeam(LegoObject *liveObj);
BOOL __cdecl lego::game::LegoObject_FUN_0043c750(LegoObject *liveObj,LegoObject *routeToObject,WeaponKnownType knownWeapon);
...
BOOL __cdecl lego::game::LegoObject_Proc_FUN_00442190(LegoObject *liveObj,LegoObject *targetObj,WeaponKnownType knownWeapon);
void __cdecl lego::game::LegoObject_GetWeaponUnk(LegoObject *liveObj,WeaponKnownType knownWeapon);
...
void __cdecl lego::game::LegoObject_UpdateRoutingVectors_FUN_004428b0(LegoObject *liveObj,float xDir,float yDir);
...
void __cdecl lego::game::LegoObject_FaceTowardsCamera(LegoObject *liveObj,Point2F *camWorldPos);
...
BOOL __cdecl lego::game::LegoObject_Callback_ScareTrainedMiniFiguresAwayFromTickingDynamite(LegoObject *liveObj,LegoObject *otherObj);
...
void __cdecl lego::game::LegoObject_Hit(LegoObject *liveObj,Point2F *dir,BOOL reactToHit);
...
void __cdecl lego::game::LegoObject_SimpleObject_FUN_00448160(LegoObject *in_liveObj,float elapsed);
...
void __cdecl lego::game::Message_Debug_RegisterSelectedUnitHotkey(Keys8 key,Message_Type messageType,LegoObject *argumentObj,undefined4 argument2,Point2I *opt_position);
...
BOOL __cdecl lego::game::Message_PTL_Select_LiveObject(LegoObject *liveObj,BOOL noDoubleSelect);
BOOL __cdecl lego::game::Message_LiveObject_DoSelect_FUN_004529a0(LegoObject *liveObj,BOOL noDoubleSelect,BOOL interrupt);
...
BOOL __cdecl lego::game::Message_PTL_FirstPerson(uint cameraFrame);
...
void __cdecl lego::front::Pointer_LoadPointers(Config *config);
...
RadarMap * __cdecl lego::game::RadarMap_Create(Map3D *map,Area2F *radarViewRect,float tvTiltOrZoom);
...
Point2I * __cdecl lego::gfx::SelectPlace_CheckAndUpdate(SelectPlace *selectPlace,Point2I *blockPos,Point2I *shapePoints,uint shapeCount,Direction direction,Map3D *surfMap,int waterEntrances);
...
int __cdecl lego::gfx::SFX_Container_Random_Play_OrInitSoundUnk(Container *cont,SFX_ID sfxID,BOOL loop,BOOL sound3D,Vector3F *opt_wPos);
int __cdecl lego::snd::SFX_Random_Play_OrInitSoundUnk(IDirect3DRMFrame3 *frame,SFX_ID sfxID,BOOL loop,BOOL sound3D,Vector3F *opt_wPos);
...
void __cdecl lego::game::Water_InitGroups(Container *root,Lego_Level *level);
...
float10 __cdecl lego::tools::Weapon_GetRechargeTime(int weaponID);
float10 __cdecl lego::tools::Weapon_GetDischargeRate(int weaponID);
float10 __cdecl lego::tools::Weapon_GetWeaponRange(int weaponID);
float10 __cdecl lego::tools::Weapon_GetWallDestroyTime(int weaponID,Lego_SurfaceType surfaceType);
float10 __cdecl lego::tools::Weapon_GetDamageForObject(int weaponID,LegoObject *liveObj);
void __cdecl lego::tools::Weapon_GenericDamageObject(LegoObject *liveObj,int weaponID,BOOL unkSlowDeathBool,float elapsed,Point2F *dir);
...
BOOL __cdecl lego::tools::Weapon_LegoObject_Callback_FUN_0046f8d0(LegoObject *liveObj,float *pElapsed);
void __cdecl lego::tools::Weapon_GunHitObject(LegoObject *liveObj,Vector3F *dir,Vector3F *opt_worldPos,int weaponID,WeaponKnownType knownWeapon);
void __cdecl lego::tools::Weapon_Projectile_UpdatePath(Weapon_Projectile *projectile,float elapsed);
BOOL __cdecl lego::tools::Weapon_Projectile_AddStraightPath(LegoObject *liveObj,Vector3F *fromPos,Vector3F *toPos,int weaponID,WeaponKnownType knownWeapon);
BOOL __cdecl lego::tools::Weapon_Projectile_AddCurvedPath(LegoObject *liveObj,Vector3F *fromPos,Vector3F *toPos,int weaponID,WeaponKnownType knownWeapon);
void __cdecl lego::tools::Weapon_GetObjectTypeAndID_ByKnownWeaponType(WeaponKnownType knownWeapon,LegoObject_Type *out_objType,LegoObject_ID *out_objID);
...
BOOL __cdecl lego::tools::Weapon_LegoObject_TestCollision_FUN_004708f0(LegoObject *liveObj,Point2F *fromPos,Point2F *scalar2D);
...
BOOL __cdecl lego::tools::Weapon_LegoObject_IsActiveTracker(LegoObject *liveObj);
BOOL __cdecl lego::tools::Weapon_LegoObject_UpdateLaserTracker(LegoObject *liveObj,float elapsed,uint frameNo);
BOOL __cdecl lego::tools::Weapon_LegoObject_UpdateNonLaserTracker(LegoObject *liveObj,float elapsed,uint frameNo);
