...
BOOL __cdecl lego::ai::AITask_Callback_IfAttackPath_FUN_004029a0(AITask *aiTask,Point2I **search);
BOOL __cdecl lego::ai::AITask_LiveObject_DoCallbacks_FUN_004029d0(void *liveObj);
BOOL __cdecl lego::ai::AITask_Callback_FUN_004029f0(AITask *aiTask,LegoObject *liveObj);
void __cdecl lego::ai::AITask_Block_FUN_00402a10(Point2I *blockPos,undefined4 param_2);
...
BOOL __cdecl lego::ai::AITask_Callback_FUN_00402ae0(AITask *aiTask,Point2I **search);
BOOL __cdecl lego::ai::AITask_Callback_FUN_00402b50(AITask *aiTask,Point2I **search);
BOOL __cdecl lego::ai::AITask_Callback_FUN_00402ba0(AITask *aiTask,Point2I **search);
BOOL __cdecl lego::ai::AITask_Callback_FUN_00402bd0(AITask *aiTask,Point2I **search);
...
void __cdecl lego::ai::AITask_Game_PTL_UserGoto(LegoObject **liveObjsTable,int count,Point2I *blockPos,BOOL param_4);
...
void __cdecl lego::ai::AITask_Game_PTL_GotoOrRMGoto(LegoObject *liveObj,Point2I *blockPos,undefined4 param_3);
...
BOOL __cdecl lego::gfx::Creature_Load(CreatureModel *creature,int objID,Container *root,char *filename,char *gameName);
...
void __cdecl lego::gfx::Creature_SwapPolyFP(CreatureModel *creature,BOOL swap,int cameraFrameIndex);
...
float10 __cdecl lego::gfx::Creature_MoveAnimation(CreatureModel *creature,float elapsed,uint unkFrameNo);
...
Container * __cdecl lego::gfx::Object_SearchForPartName(BasicObjectModel *basicObjData,char *name,uint frameNo);
...
BOOL __cdecl lego::gfx::Creature_GetThrowNull(CreatureModel *creature);
...
void __cdecl lego::front::Bubble_LiveObject_GetBubbleImage_FUN_004077f0(LegoObject *liveObj,float param_2,Image **out_bubbleImage,Point2F *out_screenPt);
...
BOOL __cdecl lego::gfx::Building_Load(BuildingModel *building,int objID,Container *root,char *filename,char *gameName);
void __cdecl lego::gfx::Building_AnimatePowerLevelScene(BuildingModel *building,BOOL forward);
...
float10 __cdecl lego::gfx::Building_MoveAnimation(BuildingModel *building,float elapsed,uint unkFrameNo);
...
Point2F * __cdecl lego::math::Collision_Maths_FUN_00408a90(Point2F *param_1,Point2F *param_2,Point2F *position,Point2F *result);
Point2F * __cdecl lego::math::Collision_MathUnk_Vector2D_FUN_00408b20(Point2F *param_1,Point2F *param_2,Point2F *position,Point2F *result);
...
void __cdecl lego::game::Construction_FUN_00408df0(Point2I *blockPos,Point2I *shapePoints,uint shapeCount);
...
BlockElectricFence * __cdecl lego::game::ElectricFence_AssignBlockObject(LegoObject *liveObj);
BlockElectricFence * __cdecl lego::game::ElectricFence_Create(LegoObject *liveObj,int bx,int by);
...
void __cdecl lego::game::ElectricFence_Remove(BlockElectricFence *efence,int bx,int by);
...
void __cdecl lego::game::ElectricFence_LiveObject_SparkBlock_FUN_0040dff0(LegoObject *liveObj,Point2F *objWorldPos,uint bx,uint by);
...
void __cdecl lego::front::Interface_UnkSlideOffScreen_FUN_0041e980_internal(Interface_MenuType interfaceMenuType,Point2I *opt_blockPos);
void __cdecl lego::front::Interface_FUN_0041e9f0(float elapsedAbs);
void __cdecl lego::front::Interface_DrawTeleportQueueNumber(int param_1,int param_2,Point2F *screenPt);
...
BOOL __cdecl lego::front::Interface_LiveObject_Callback_FUN_0041f2c0(LegoObject *liveObj,Point2I *blockPos);
...
BOOL __cdecl lego::lrr::Lego_HandleKeys(float elapsedGame,float param_2,BOOL *out_keyDownT,BOOL *out_keyDownR,BOOL *out_keyDownShift);
...
void __cdecl lego::game::Game_MainView_MouseTransform(uint mouseX,uint mouseY,float *out_xPos,float *out_yPos);
...
BOOL __cdecl lego::lrr::Lego_GetBlockCryOre(Point2I *blockPos,int *out_crystalLv0,int *out_oreLv0,int *out_crystalLv1,int *out_oreLv1);
...
Upgrade_PartModel * __cdecl lego::game::Game_GetUpgradeData(char *upgradeName);
...
BOOL __cdecl lego::game::Object_GetObjectByName(char *objName,LegoObject_Type *out_objType,LegoObject_ID *out_objID,Container **optout_cont);
BOOL __cdecl lego::game::Object_GetTypeActivityContainer(LegoObject_Type objType,LegoObject_ID objID,Container **out_cont);
...
BOOL __cdecl lego::game::Level_Block_Damage(uint bx,uint by,float param_3,float param_4);
...
BOOL __cdecl lego::game::Game_TryTeleportObject(LegoObject_Type objType,LegoObject_ID objID);
...
void __cdecl lego::save::Object_Save_OverwriteStruct18(SaveStruct_18 *saveStruct18);
int __cdecl lego::game::LegoObject_GetObjectsBuilt(LegoObject_Type objType,BOOL excludeToolStore);
void __cdecl lego::game::Object_LoadToolTipIcons(Config *root);
void __cdecl lego::game::LegoObject_CleanupLevel(void);
void __cdecl lego::game::LegoObject_Weapon_FUN_004375c0(LegoObject *liveObj,int weaponType,float param_3);
...
uint __cdecl lego::game::LegoObject_GetLevelObjectsBuilt(LegoObject_Type objType,LegoObject_ID objID,int objLevel,BOOL currentLevel);
uint __cdecl lego::game::LegoObject_GetPreviousLevelObjectsBuilt(LegoObject_Type objType,LegoObject_ID objID,int objLevel);
void __cdecl lego::game::LegoObject_IncLevelPathsBuilt(BOOL incCurrent);
void __cdecl lego::game::LegoObject_FUN_004377b0(LegoObject *liveObj);
BOOL __cdecl lego::game::LegoObject_Callback_UnkDoRouting_IfObject2FC(LegoObject *liveObj1,LegoObject *liveObj2);
BOOL __cdecl lego::game::LegoObject_Remove(LegoObject *liveObj);
BOOL __cdecl lego::game::LegoObject_RunThroughListsSkipIgnoreMes(LegoObject_RunThroughListsCallback callback,void *search);
BOOL __cdecl lego::game::LegoObject_RunThroughLists(LegoObject_RunThroughListsCallback callback,void *search,BOOL skipIgnoreMeObjs);
...
void __cdecl lego::game::HiddenObject_Add(void *objSrcData,LegoObject_Type objType,LegoObject_ID objID,Point2F *worldPos,float heading,float health,char *thisOLName,char *drivingOLName);
...
BOOL __cdecl lego::game::LegoObject_CheckCondition_AndIsPowered(LegoObject *liveObj,BOOL state);
LegoObject * __cdecl lego::game::LegoObject_CreateInWorld(void *objSrcData,LegoObject_Type objType,LegoObject_ID objID,int objLevel,float xPos,float yPos,float heading);
LegoObject * __cdecl lego::game::Game_Unk_DoSearchCallbacks_Unique(Point2I *blockPos);
BOOL __cdecl lego::game::LiveManager_FUN_00438970(LegoObject *liveObj,LegoObject **param_2);
...
void __cdecl lego::game::LegoObject_FUN_00438ab0(LegoObject *in_liveObj);
...
LegoObject * __cdecl lego::game::LegoObject_FUN_00438d20(Point2I *blockPos,LegoObject_Type objType,int objID,int objLevel);
LegoObject * __cdecl lego::game::LegoObject_FUN_00438da0(LegoObject *liveObj,Point2I *blockPos,LegoObject_Type objType,int objLevel);
...
undefined4 __cdecl lego::game::LegoObject_Search_FUN_00438f20(LegoObject *liveObj);
LegoObject * __cdecl lego::game::Game_FindBigTeleporter(Point2F *worldPos);
LegoObject * __cdecl lego::game::Game_FindSmallTeleporter(Point2F *worldPos);
LegoObject * __cdecl lego::game::Game_FindWaterTeleporter(Point2F *worldPos);
LegoObject * __cdecl lego::game::Level_GetBuildingAtPosition(Point2F *worldPos);
undefined4 __cdecl lego::game::LegoObject_Search_FUN_00439110(LegoObject *liveObj,Point2F *opt_worldPos,TrainedFlags trainedType);
BOOL __cdecl lego::game::LegoObject_HasTraining(LegoObject *liveObj,TrainedFlags training);
...
void __cdecl lego::game::Game_PTL_GenerateFromCryOre(Point2I *blockPos);
...
BOOL __cdecl lego::game::LegoObject_SetLevel(LegoObject *liveObj,int objLevel);
...
LegoObject * __cdecl lego::game::LegoObject_FUN_0043a910(LegoObject *liveObj,LegoObject_Type objType,int objID,int objLevel);
BOOL __cdecl lego::game::LegoObject_CanSpawnCarryableObject(LegoObject *liveObj,LegoObject_Type objType,int objID);
void __cdecl lego::game::LegoObject_FUN_0043ab10(LegoObject *liveObj,LegoObject *liveObj2);
void __cdecl lego::game::Level_AddCrystals__unusedLegoObject(LegoObject *liveObj_unused,uint crystalCount);
void __cdecl lego::game::Level_AddOre__unusedLegoObject(LegoObject *liveObj_unused,uint oreCount);
...
LegoObject * __cdecl lego::game::LegoObject_TryGenerateSlug(LegoObject *originObj,uint objID);
LegoObject * __cdecl lego::game::LegoObject_TryGenerateRMonsterAtRandomBlock(void);
LegoObject * __cdecl lego::game::LegoObject_TryGenerateRMonster(int **objModel,LegoObject_Type objType,int objID,uint bx,uint by);
...
BOOL __cdecl lego::game::LegoObject_Callback_FUN_0043b670(LegoObject *liveObj,int **param_2);
...
void __cdecl lego::game::LegoObject_SwapPolyFP(LegoObject *liveObj,int cameraFrameIndex,BOOL on);
void __cdecl lego::game::LegoObject_FP_SetRanges(LegoObject *liveObj,Container *resData,float medPolyRange,float highPolyRange,BOOL param_5);
...
void __cdecl lego::game::LegoObject_FUN_0043be80(LegoObject *liveObj);
void __cdecl lego::game::LegoObject_TeleportUp(LegoObject *liveObj);
BOOL __cdecl lego::game::Object_DoOxygenCheck_FUN_0043c4c0(LegoObject_Type objType1,LegoObject_ID objID1,LegoObject_Type objType2,LegoObject_ID objID2);
BOOL __cdecl lego::game::LegoObject_OxygenCallback_FUN_0043c540(LegoObject *liveObj,float *param_2);
void __cdecl lego::game::LiveManager_UnkRadar_FUN_0043c570(float elapsedGame,BOOL isRadarMapView);
BOOL __cdecl lego::game::LegoObject_Callback_FUN_0043c5b0(LegoObject *liveObj,BOOL *pIsRadarMapView);
BOOL __cdecl lego::game::LegoObject_FUN_0043c6a0(LegoObject *liveObj);
uint __cdecl lego::game::LegoObject_GetEquippedBeam(LegoObject *liveObj);
BOOL __cdecl lego::game::LegoObject_FUN_0043c750(LegoObject *liveObj,LegoObject *object2FC,int param_3);
...
void __cdecl lego::game::LegoObject_FUN_0043c970(LegoObject *liveObj,float elapsed);
void __cdecl lego::game::LegoObject_ProcCarriedObjects_FUN_0043f160(LegoObject *in_liveObj);
void __cdecl lego::game::LegoObject_ClearFlags4_40_AndSameForObject2FC(LegoObject *unused_liveObj,LegoObject *liveObj);
...
void __cdecl lego::game::LegoObject_FUN_0043f450(LegoObject *liveObj);
BOOL __cdecl lego::game::LegoObject_RemoveObject3CC(LegoObject *liveObj);
BOOL __cdecl lego::game::LegoObject_CallbackRemoveObject3CC(LegoObject *liveObj,LegoObject *otherObj);
void __cdecl lego::game::LegoObject_TrainMiniFigure_instantunk(LegoObject *liveObj,TrainedFlags trainFlags);
void __cdecl lego::game::LegoObject_AddDamage2(LegoObject *liveObj,float damage,BOOL param_3,float param_4);
void __cdecl lego::game::LegoObject_UnkUpdateEnergyHealth(LegoObject *in_liveObj,float elapsed);
BOOL __cdecl lego::game::LegoObject_MiniFigurePlayHurtSND(LegoObject *in_liveObj,float elapsed,float damage);
...
BOOL __cdecl lego::game::LegoObject_Callback_DynamiteRadius(LegoObject *liveObj,SearchDynamiteRadius *search);
...
BOOL __cdecl lego::game::LegoObject_CallbackProc_FUN_00440be0(LegoObject *liveObj,LegoObject **search);
...
BOOL __cdecl lego::game::LegoObject_FUN_00440ef0(LegoObject *liveObj,undefined4 param_2,undefined4 param_3,undefined4 param_4,undefined4 param_5,undefined4 param_6,undefined4 param_7,undefined4 param_8);
BOOL __cdecl lego::game::LegoObject_FUN_00440f30(LegoObject *liveObj,uint param_2,uint param_3,uint param_4,uint param_5,uint **param_6,uint **param_7,uint *param_8,undefined *param_9,undefined4 param_10);
BOOL __cdecl lego::game::LegoObject_FUN_004413b0(LegoObject *liveObj,uint bx,uint by,uint param_4,uint param_5,uint **param_6,uint **param_7,float *param_8,code *callback,undefined4 param_10);
BOOL __cdecl lego::game::LegoObject_RoutingPtr_Alloc_FUN_004419c0(LegoObject *liveObj,uint count,float *param_3,float *param_4,float *param_5);
void __cdecl lego::game::LegoObject_UnkDoRouting_FUN_00441c00(LegoObject *in_liveObj,BOOL param_2);
...
BOOL __cdecl lego::game::LegoObject_Proc_FUN_00442190(LegoObject *liveObj,LegoObject *targetObj,int param_3);
void __cdecl lego::game::Game_GetWeaponUnk(LegoObject *liveObj,int weaponType);
void __cdecl lego::game::LegoObject_UnkActivityCrumble_FUN_004424d0(LegoObject *liveObj);
...
void __cdecl lego::game::LegoObject_UnkUpdateOrientation(LegoObject *liveObj,float theta,Vector3F *opt_vecDir);
...
void __cdecl lego::game::LegoObject_FUN_004428b0(LegoObject *liveObj,float xDir,float yDir);
...
void __cdecl lego::game::LegoObject_RockFall_FUN_00443240(LegoObject *in_liveObj,float param_2);
void __cdecl lego::game::LegoObject_UpdateDriverObjectPositions_FUN_004437d0(LegoObject *liveObj);
BOOL __cdecl lego::game::LegoObject_FUN_00443930(LegoObject *liveObj);
BOOL __cdecl lego::game::LegoObject_IsRockMonsterCanGather(LegoObject *liveObj);
BOOL __cdecl lego::game::LegoObject_FUN_004439d0(LegoObject *liveObj,Point2I *blockPos,Point2I *out_pointUnkForI,undefined4 unused);
void __cdecl lego::game::LegoObject_RockMonster_DoWakeUp(LegoObject *liveObj);
BOOL __cdecl lego::game::LegoObject_FUN_00443b00(LegoObject *liveObj,Point2I *blockPos,BOOL *pAlsoCheckBlockFlags1_10Not8);
void __cdecl lego::game::LegoObject_LargeFlagsSwitch_FUN_00443b70(LegoObject *in_liveObj,float param_2);
void __cdecl lego::game::LegoObject_TryDock_AtObject2FC(LegoObject *liveObj);
void __cdecl lego::game::LegoObject_FUN_004443b0(LegoObject *liveObj,float elapsed);
BOOL __cdecl lego::game::LegoObject_FUN_00444520(LegoObject *liveObj);
void __cdecl lego::game::LegoObject_FUN_00444720(LegoObject *liveObj,Point2F *worldPos);
void __cdecl lego::ai::LegoObject_DoSlip(LegoObject *liveObj);
BOOL __cdecl lego::game::LegoObject_RoutingUnk_FUN_00444940(LegoObject *liveObj,int param_2,int param_3,int param_4);
void __cdecl lego::game::LegoObject_FUN_00445270(LegoObject *liveObj,Point2F *worldPos);
void __cdecl lego::game::LegoObject_FUN_004454a0(LegoObject *in_liveObj);
BOOL __cdecl lego::game::LegoObject_Callback_FUN_00445600(LegoObject *liveObj1,LegoObject **param_2);
BOOL __cdecl lego::game::LegoObject_FUN_00445860(LegoObject *liveObj);
void __cdecl lego::game::LegoObject_FUN_004459a0(LegoObject *liveObj);
BOOL __cdecl lego::game::LegoObject_Callback_FUN_00445a30(LegoObject *liveObj1,LegoObject *liveObj2);
BOOL __cdecl lego::game::LegoObject_Callback_FUN_00445af0(LegoObject *liveObj1,LegoObject *liveObj2);
...
BOOL __cdecl lego::game::LegoObject_CallbackCollisionRadius_FUN_004460b0(LegoObject *in_liveObj,int *search);
...
void __cdecl lego::game::LegoObject_FUN_004477b0(LegoObject *in_liveObj);
...
void __cdecl lego::game::LegoObject_FUN_00447a90(LegoObject *liveObj);
...
void __cdecl lego::game::LegoObject_FUN_00447c10(LegoObject *liveObj,Point2F *param_2,BOOL param_3);
void __cdecl lego::game::LegoObject_TeleportDownBuilding(LegoObject *liveObj);
float10 __cdecl lego::game::LegoObject_FUN_00447df0(LegoObject *liveObj,float elapsed);
BOOL __cdecl lego::game::LegoObject_Container_ActivityUpdate_Check(LegoObject *liveObj);
void __cdecl lego::game::LegoObject_FUN_00448160(LegoObject *in_liveObj,float elapsed);
...
BOOL __cdecl lego::game::LegoObject_Reinforcing_FUN_00449c40(LegoObject *liveObj,undefined4 param_2,BOOL *out_bool);
...
void __cdecl lego::game::LiveManager_AllCallback_FUN_00449ec0(void);
void __cdecl lego::game::LegoObject_FlocksCallback_FUN_00449ee0(Flocks *flockData,FlocksItem *subdata,void *data);
void __cdecl lego::game::LegoObject_Hide2(LegoObject *liveObj,BOOL hide2);
BOOL __cdecl lego::game::LegoObject_Callback_FUN_00449fb0(LegoObject *liveObj,void *unused);
...
BOOL __cdecl lego::game::LegoObject_FUN_0044a890(LegoObject *liveObj,int *param_2,int *param_3,BOOL param_4,BOOL param_5,BOOL param_6);
BOOL __cdecl lego::unk::Lego_QsortCompare_FUN_0044aa60(int param_1,int param_2);
MeshLOD * __cdecl lego::gfx::Res_LoadMeshLOD(Config *act,char *gameName,char *dirname,LOD_PolyLevel polyLOD,uint numCameraFrames);
...
void __cdecl lego::game::LegoObject_SetGlobFlag20(BOOL state);
...
void __cdecl lego::game::Flocks_Container_ReleaseCallback(Flocks *flockData,FlocksItem *subdata,void *data);
...
BOOL __cdecl lego::game::LegoObject_FUN_0044c2f0(LegoObject *liveObj,float elapsed);
...
void __cdecl lego::game::LegoObject_FUN_0044c470(LegoObject *liveObj,float elapsed);
void __cdecl lego::game::LegoObject_FUN_0044c760(LegoObject *liveObj);
BOOL __cdecl lego::game::LegoObject_Callback_UnkLaserTrackerToggleUnset_FUN_0044c7c0(LegoObject *liveObj,void *unused);
...
BOOL __cdecl lego::map::Map3D_FUN_0044fe50(Map3D *map,float in_x,float in_y,BOOL gap,float unkMultiplier,float *out_x,float *out_y);
...
float10 __cdecl lego::gfx::Upgrade_Part_MoveAnimation(Upgrade_PartModel *upgradePart,float elapsed,uint unused_unkFrameNo);
...
float10 __cdecl lego::gfx::Vehicle_MoveAnimation(VehicleModel *vehicle,float elapsed1,float elapsed2,uint unkFrameNo);
void __cdecl lego::gfx::Vehicle_PopulateWheels(VehicleModel *vehicle);
...
Container * __cdecl lego::gfx::Vehicle_GetNull(VehicleModel *vehicle,char *nullName,uint nullFrameNo);
...
float10 __cdecl lego::tools::Weapon_GetDamageForLegoObject(int weaponType,LegoObject *liveObj);
void __cdecl lego::tools::Weapon_LegoObject_FUN_0046f530(LegoObject *liveObj,int weaponType,BOOL param_3,float param_4,Point2F *param_5);
void __cdecl lego::tools::Weapon_LegoObject_FUN_0046f640(LegoObject *liveObj,float param_2,BOOL param_3);
...
BOOL __cdecl lego::tools::Weapon_LegoObject_Callback_FUN_0046f8d0(LegoObject *liveObj,float *lpElapsed);
void __cdecl lego::tools::Weapon_LegoObject_FUN_0046fa30(LegoObject *liveObj,Vector3F *param_2,Vector3F *worldPos,uint weaponType,WeaponKnownType knownWeapon);
void __cdecl lego::tools::Weapon_Struct2B0_FUN_0046fbe0(Struct_2b0 *param_1,float elapsed);
BOOL __cdecl lego::tools::Weapon_Struct2B0_FUN_0046fdb0(LegoObject *liveObj,Vector3F *param_2,Vector3F *param_3,uint weaponType,WeaponKnownType param_5);
...
void __cdecl lego::tools::Weapon_GetObjectTypeAndID_ByKnownWeaponType(WeaponKnownType knownWeapon,LegoObject_Type *out_objType,int *out_objID);
int __cdecl lego::tools::Weapon_Struct2B0_GetNextAvailable(void);
int __cdecl lego::tools::Weapon_ItemStruct34_GetNextAvailable(void);
...
BOOL __cdecl lego::tools::Weapon_LegoObject_Collision_FUN_00470520(LegoObject *liveObj,Point2F *param_2,Point2F *param_3,BOOL param_4);
BOOL __cdecl lego::tools::Weapon_LegoObject_CollisionBox_FUN_00470570(LegoObject *liveObj,Point2F *param_2,Point2F *param_3,Point2F *optout_point,BOOL param_5);
BOOL __cdecl lego::tools::Weapon_LegoObject_CollisionRadius_FUN_00470800(LegoObject *liveObj,Point2F *param_2,Point2F *param_3,BOOL param_4);
BOOL __cdecl lego::tools::Weapon_LegoObject_TestCollision_FUN_004708f0(LegoObject *liveObj,Point2F *fromPos,Point2F *scalar);
void __cdecl lego::tools::Weapon_ItemStruct34_FUN_00470950(Container *cont,Vector3F *vector1,Vector3F *vector2);
void __cdecl lego::tools::Weapon_Struct34_FUN_00470a20(Mesh *param_1,float scalar,Vector3F *vector1,Vector3F *vector2,float param_5,float param_6,float param_7,float param_8);
...
BOOL __cdecl lego::tools::Weapon_LegoObject_Callback_FUN_00471630(LegoObject *liveObj,SearchData18_2 *search);
void __cdecl lego::tools::Weapon_LegoObject_FUN_004718f0(SearchData18_2 *search);
BOOL __cdecl lego::tools::Weapon_DoCallbacksSearch_FUN_00471b20(Vector3F *vecCector,Vector3F *vecDistance,LegoObject **out_liveObj,float *ref_float_4,undefined4 param_5);
...
void __cdecl lego::tools::Weapon_UnkStruct_FUN_00471d20(WeaponsModel *weapons,Vector3F *vector68,float param_3,BOOL assignVectors68,uint frameNo);
void __cdecl lego::tools::Weapon_GetVectors44(WeaponsModel *weapons,Vector3F *out_vector44,uint frameNo);
BOOL __cdecl lego::tools::Weapon_LegoObject_GetCollCenterPosition(LegoObject *liveObj,Vector3F *out_vector);
BOOL __cdecl lego::tools::Weapon_LegoObject_IsPoweredTracker(LegoObject *liveObj);
BOOL __cdecl lego::tools::Weapon_LegoObject_FUN_00471fe0(LegoObject *liveObj,float elapsed,uint frameNo);
BOOL __cdecl lego::tools::Weapon_LegoObject_FUN_004721c0(LegoObject *liveObj,float elapsed,uint frameNo);
BOOL __cdecl lego::tools::Weapon_LegoObject_FUN_00472280(LegoObject *liveObj,float elapsed);
BOOL __cdecl lego::tools::Weapon_LegoObject_SetObject_3c4(LegoObject *liveObj,LegoObject *object3c4);
