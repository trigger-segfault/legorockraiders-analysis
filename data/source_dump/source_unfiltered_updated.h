...
void __cdecl lego::front::Advisor_Init(char *keyRoot,Struct_bc *structbc,void *ptr_1c);
...
void __cdecl lego::res::Creature_FUN_00406b30(CreatureData *creature,BOOL param_2);
void __cdecl lego::res::Creature_FUN_00406b60(CreatureData *creature,BOOL param_2);
void __cdecl lego::res::Creature_FUN_00406b90(CreatureData *creature,int param_2,int param_3);
...
void __cdecl FUN_00429040(int param_1,int param_2);
...
Struct_bc * __cdecl lego::view::Camera_Create(ResourceData *resData,int mode);
void __cdecl lego::view::Camera_Debug_AllowEditModeFunc1(Struct_bc *cam,BOOL modeDisableUnk);
void __cdecl lego::view::Camera_Cleanup(Struct_bc *cam);
...
void __cdecl lego::view::Camera_CopyPositionOrientation(Struct_bc *dstCamera,Struct_bc *srcCamera);
void __cdecl lego::view::Camera_FUN_00435deb(Struct_bc *cam,LiveObject *liveObj,float param_3,float param_4,float param_5,float param_6);
void __cdecl lego::view::Camera_SetObject4_Field14(Struct_bc *cam,LiveObject *liveObj,undefined4 param_3);
undefined4 __cdecl lego::view::Camera_GetField14(Struct_bc *cam);
void __cdecl lego::view::Camera_ZeroField9c_UnkSpeedAccel(Struct_bc *cam);
int __cdecl lego::view::Camera_GetMouseScrollIndent(void);
void __cdecl lego::view::Camera_SetFloata0_a4_Zeroa8(Struct_bc *cam,float param_2,float param_3);
void __cdecl lego::view::Camera_FUN_00435e8c(Struct_bc *cam,LevelData *level,float param_3,float param_4);
void __cdecl lego::view::Camera_SetFloat7c_80_AndFlag1(Struct_bc *cam,float param_2,float param_3);
void __cdecl lego::view::Camera_FUN_00436a82(Struct_bc *cam,float param_2);
void __cdecl lego::view::Camera_FUN_00436b22(Struct_bc *cam,float param_2);
void __cdecl lego::view::Camera_SetFloat88_8c_AndFlag2(Struct_bc *cam,float param_2,float param_3);
void __cdecl lego::view::Camera_SetFrameZRotOrientation(Struct_bc *cam,float param_2);
void __cdecl lego::view::Camera_AddFrameZRotOrientation(Struct_bc *cam,float param_2);
void __cdecl lego::view::Camera_SetFloat94_98_AndFlag4(Struct_bc *cam,float param_2,float param_3);
void __cdecl lego::view::Camera_SetFloat90_IfBounds(Struct_bc *cam,float param_2);
void __cdecl lego::view::Camera_AddFloat90_IfBounds(Struct_bc *cam,float param_2);
void __cdecl lego::view::Camera_AddTranslation2F(Struct_bc *cam,float translateX,float translateY);
void __cdecl lego::view::Camera_GetFramePosition_IfMode1(Struct_bc *cam,Vector3F *out_position);
void __cdecl lego::view::Camera_SetFramePosition_IfMode1(Struct_bc *cam,float x,float y);
BOOL __cdecl lego::view::Camera_GetSurfacePosition(Struct_bc *cam,SurfaceMap *surfMap,Vector3F *out_surfPosition);
float10 __cdecl FUN_00436d9b(int param_1);
void __cdecl lego::view::Camera_FUN_00436da9(Struct_bc *cam,Vector3F *ref_vector,float unkScalar);
...
BOOL __cdecl lego::game::LiveObject_FUN_00438870(LiveObject *liveObj,BOOL state);
...
void __cdecl lego::game::LiveObject_FUN_0043bae0(LiveObject *liveObj,int param_2,int param_3);
...
BOOL __cdecl FUN_0044abd0(ObjectType objType,int objIndex,BOOL param_3,BOOL param_4,Point2F *param_5,uint x,uint y,BOOL param_8,ResourceData **resData);
...
void __cdecl FUN_0044b110(LiveObject *in_liveObj,int crystalCount,BOOL param_3);
...
void __cdecl lego::game::SurfaceMap_FadeInBlock(SurfaceMap *surfaceMap,int x,int y,uint param_4,uint param_5);
...
void __cdecl FUN_0044ed90(SurfaceMap *param_1,uint *param_2,uint param_3,float param_4);
...
BOOL __cdecl lego::game::SurfaceMap_ToBlockCoordinatesNoZ(SurfaceMap *surfaceMap,float in_x,float in_y,int *out_x,int *out_y);
BOOL __cdecl lego::game::SurfaceMap_ToBlockCoordinates(SurfaceMap *surfaceMap,float in_x,float in_y,int *out_x,int *out_y,float *out_unk_z);
void __cdecl lego::game::SurfaceMap_FUN_0044fad0(SurfaceMap *surfMap,float in_x,float in_y,int *out_x,int *out_y);
undefined4 __cdecl FUN_0044fb30(SurfaceMap *surfaceMap,Point2F *param_2,Point2F *param_3,Point2F *param_4);
float10 __cdecl lego::game::SurfaceMap_UnkGetZ(SurfaceMap *surfMap,float x,float y);
void __cdecl FUN_0044fd70(uint *param_1,float param_2,float param_3,undefined4 *param_4);
undefined4 __cdecl FUN_0044fe50(SurfaceMap *surfMap,float param_2,float param_3,int param_4,float param_5,float *param_6,float *param_7);
float10 __cdecl FUN_00450130(SurfaceMap *surfMap,float param_2,float param_3);
void __cdecl FUN_00450320(SurfaceMap *surfMap,int param_2,int param_3,undefined4 *param_4);
...
uint __cdecl FUN_00450580(SurfaceMap *param_1,uint x,uint y);
...
void __cdecl FUN_004508c0(SurfaceMap *surfMap,int param_2,int param_3,int param_4,undefined *param_5);
void __cdecl FUN_004509c0(SurfaceMap *surfMap,int x,int y,BOOL state);
void __cdecl FUN_004509f0(int *param_1,int param_2,int param_3);
void __cdecl FUN_00450a40(SurfaceMap *surfMap);
void __cdecl FUN_00450a90(uint *param_1,uint param_2,uint param_3,float *out_x,float *out_y,float *out_z);
float10 __cdecl lego::game::SurfaceMap_GetFloat10(SurfaceMap *surfMap);
...
BOOL __cdecl FUN_004518a0(SurfaceMap *surfMap,uint x,uint y,Vector3F *param_4,Vector3F *param_5,Vector3F *out_vector);
...
void __cdecl lego::res::PolyMesh_FUN_00451e80(PolyMeshData *polyData,ResourceData *resData,BOOL param_3,int param_4);
...
BOOL __cdecl FUN_0045b850(int param_1,float *param_2,int param_3,int param_4);
void __cdecl FUN_0045b8d0(void);
...
BOOL __cdecl FUN_0045bf90(int param_1,int param_2,float param_3);
...
BOOL __cdecl lego::front::Pointer_GetType(char *pointerName,int *out_pointerType);
...
int __cdecl lego::unk::Lego_GetInt_00501a98(void);
...
void __cdecl lego::game::LevelStruct3C_Free(LevelStruct_3c *param_1);
...
undefined4 * __cdecl FUN_004643d0(int *param_1,int param_2,int count,int param_4);
...
void __cdecl lego::res::Vehicle_FUN_0046d190(VehicleData *vehicle,BOOL param_2);
...
ResourceData * __cdecl lego::res::Res_FUN_00473e80(ResourceData *resData,char *param_2,int unkMode,undefined4 *ref_param_4);
...
void __cdecl lego::view::Viewport_FUN_004772d0(ViewportData *view,int param_2);
...
BOOL __cdecl lego::snd::SFX_UNKCallsMixer__00478c40(float param_1,float param_2);
BOOL __cdecl FUN_00478c60(float *param_1,float *param_2);
BOOL __cdecl lego::snd::SFX_UnkMixer__00478c80(float *param_1,float *param_2,BOOL param_3);
...
void __cdecl FUN_0047a410(ImageFont *font,uint *param_2,int *param_3,char *format,undefined4 *param_5);
...
BOOL __cdecl FUN_00483840(IDirect3DRMViewport *rmViewport);
...
BOOL __cdecl lego::flic::Flic_Lego_CrashesFunc_00483f40(char *param_1,int *param_2);
undefined4 __cdecl FUN_004841c0(undefined4 *param_1);
BOOL __cdecl lego::flic::Flic_OpenRead__00484220(char *filename,int *param_2);
...
void __cdecl lego::unk::Struct830_Free(Struct_830 *param_1);
