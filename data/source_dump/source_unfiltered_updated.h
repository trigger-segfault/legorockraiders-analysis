...
Struct_bc * __cdecl lego::unk::StructBC_Create(ResourceData *resData,int mode);
void __cdecl lego::debug::Debug_AllowEditModeFunc1(Struct_bc *structbc,BOOL modeDisableUnk);
void __cdecl lego::unk::StructBC_Cleanup(Struct_bc *structbc);
...
void __cdecl lego::unk::StructBC_CopyPositionOrientation(Struct_bc *dstStructbc,Struct_bc *srcStructbc);
void __cdecl lego::unk::StructBC_FUN_00435deb(Struct_bc *structbc,LiveObject *liveObj,float param_3,float param_4,float param_5,float param_6);
void __cdecl lego::unk::StructBC_SetObject4_Field14(Struct_bc *param_1,LiveObject *liveObj,undefined4 param_3);
undefined4 __cdecl lego::unk::StructBC_GetField14(Struct_bc *param_1);
void __cdecl lego::unk::StructBC_GetField9c_UnkSpeedAccel(Struct_bc *param_1);
int __cdecl lego::main::Main_GetMouseScrollIndent(void);
void __cdecl lego::unk::StructBC_SetFloata0_a4_Zeroa8(Struct_bc *param_1,float param_2,float param_3);
void __cdecl lego::unk::StructBC_FUN_00435e8c(Struct_bc *param_1,LevelData *level,float param_3,float param_4);
void __cdecl lego::unk::StructBC_SetFloat7c_80_AndFlag1(Struct_bc *param_1,float param_2,float param_3);
void __cdecl lego::unk::StructBC_FUN_00436a82(Struct_bc *structbc,float param_2);
void __cdecl lego::unk::StructBC_FUN_00436b22(Struct_bc *param_1,float param_2);
void __cdecl lego::unk::StructBC_SetFloat88_8c_AndFlag2(Struct_bc *param_1,float param_2,float param_3);
void __cdecl lego::unk::StructBC_SetFrameZRotOrientation(Struct_bc *param_1,float param_2);
void __cdecl lego::unk::StructBC_FUN_00436c16(Struct_bc *param_1,float param_2);
void __cdecl lego::unk::StructBC_SetFloat94_98_AndFlag4(Struct_bc *structbc,float param_2,float param_3);
void __cdecl lego::unk::StructBC_SetFloat90_IfBounds(Struct_bc *structbc,float param_2);
void __cdecl FUN_00436cc7(Struct_bc *structbc,float param_2);
void __cdecl lego::unk::StructBC_AddTranslation2F(Struct_bc *structbc,float translateX,float translateY);
void __cdecl lego::unk::StructBC_GetPositionRes28_IfMode1(Struct_bc *structbc,Vector3F *out_position);
void __cdecl lego::unk::StructBC_SetFramePosition_IfMode1(Struct_bc *structbc,float x,float y);
BOOL __cdecl lego::unk::StructBC_GetSurfacePosition(Struct_bc *structbc,LevelSurfaceMap *surfMap,Vector3F *out_surfPosition);
float10 __cdecl FUN_00436d9b(int param_1);
void __cdecl lego::unk::StructBC_FUN_00436da9(Struct_bc *structbc,Vector3F *param_2,float param_3);
...
void __cdecl FUN_0043b980(ViewportData *view,float *param_2,float *param_3);
...
float10 __cdecl FUN_00450130(LevelSurfaceMap *surfMap,float param_2,float param_3);
void __cdecl FUN_00450320(LevelSurfaceMap *surfMap,int param_2,int param_3,undefined4 *param_4);
BOOL __cdecl lego::game::SurfaceMap_FillStruct30_FUN_00450390(LevelSurfaceMap *surfMap,uint x,uint y,undefined4 *param_4);
...
BOOL __cdecl FUN_004505a0(LevelSurfaceMap *surfMap,ViewportData *view,uint param_3,uint param_4,uint *out_x,uint *out_y,float *param_7);
...
BOOL __cdecl FUN_0045c930(undefined4 param_1,int param_2,int param_3);
...
BOOL __cdecl FUN_0045e990(LevelStruct_3c *param_1,uint x,uint y,Point2F *out_pointf,int *out_blockx,int *out_blocky);
BOOL __cdecl FUN_0045eae0(LevelStruct_3c *param_1,uint x,uint y,undefined4 *param_4,undefined4 *param_5);
BOOL __cdecl FUN_0045eba0(LiveObject *param_1,LiveObject **param_2);
...
BOOL __cdecl lego::main::lego::reward::Reward_LoadBaseGraphics(CFGProperty *root,char *rootPath);
...
void lego::reward::RewardFrontEnd_Free(void);
...
undefined4 __cdecl lego::unk::Callback_FUN_004605d0(LiveObject *liveObj,int param_2);
...
undefined4 __cdecl lego::reward::Reward_FUN_00461330(void);
...
RewardSubstruct_20 * __cdecl FUN_00462c90(RewardStruct_28 *param_1,char *text,ImageFont *font,undefined4 param_4,int vertSpacing,uint unkFlags);
...
void __cdecl FUN_004631e0(int x,int y,Vector3F *param_3,Vector3F *param_4,Vector3F *param_5,Vector3F *param_6);
...
BOOL __cdecl lego::main::Main_Direct3DRMCreate(DeviceMode *device,IUnknown *ddraw1,IDirectDrawSurface4 *ddSurface4,BOOL isFullScreen);
...
float10 __cdecl FUN_004798f0(Vector3F *param_1,Vector3F *param_2,Vector3F *param_3,BOOL param_4);
...
void __cdecl lego::avi::InitAVIFile(IDirectDraw4 *ddraw4);
...
undefined8 __cdecl FUN_0048e894(uint param_1,uint param_2);
