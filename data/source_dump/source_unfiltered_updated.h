...
Point2F * __cdecl lego::game::Collision_Maths_FUN_00408a90(Point2F *param_1,Point2F *param_2,Point2F *position,Point2F *out_point);
...
void __cdecl lego::game::Dependencies_Object_Getter_FUN_0040aec0(ObjectType objType,int objIndex,int objLevel,undefined4 *out_param_4,undefined4 *out_param_5);
void __cdecl lego::game::Dependencies_Object_FUN_0040af30(ObjectType objType,int objIndex,int objLevel,int param_4);
...
void __cdecl lego::game::Dependencies_SetObjectLevelFlag_100(ObjectType objType,int objIndex,int objLevel);
uint __cdecl lego::game::Dependencies_GetObjectLevelFlag_100(ObjectType objType,int objIndex,int objLevel);
...
int __cdecl lego::effect::Effect_MiscObjectUpdateUnk_FUN_0040c2d0(float elapsedGame,undefined4 *param_2,undefined4 *param_3);
...
void __cdecl lego::front::Front_StructB8_GetGameCompleteWithPoints(SaveData *param_1,char *out_buffer);
...
void __cdecl lego::front::HelpWindow_Game_UpdateObjectDependencies(ObjectType objType,int objIndex,int objLevel,BOOL noHelpWindow);
void __cdecl lego::front::HelpWindow_Object_Dependencies_FUN_00418850(ObjectType objType,int objIndex,int objLevel);
...
int __cdecl lego::unk::Map3D_CheckComparison_FUN_00450b60(int param_1,int param_2,int param_3,int param_4);
...
void __cdecl lego::nerps::NERPs_BlockPointers_FUN_00456f70(int blockPointerIdx,undefined *callback,void *lpContext);
BOOL __cdecl lego::nerps::NERPs_UnkTutorialBlock_DoAction(undefined4 unused,int x,int y,undefined4 *param_4);
...
void __cdecl lego::front::Panel_FUN_0045a720(uint param_1,ImageFont *font,int param_3,int param_4,int param_5,char *format,...);
...
void __cdecl lego::game::Level_Block_SetVertexPositions(int bx,int by,Vector3F *param_3,Vector3F *param_4,Vector3F *param_5,Vector3F *param_6);
...
void __cdecl lego::front::Text_MsgPanel_Initialise(char *filename,uint param_2,uint param_3,uint unused_int,Rect2F *param_5,Rect2F *unused_rect,float param_7);
...
void __cdecl lego::res::Upgrade_InitUnk_FUN_0046c2f0(UpgradeData *out_upgrade,int index,Container *resRoot,char *filename);
...
void __cdecl lego::game::LiveObject_FUN_0046fa30(LiveObject *liveObj,int **param_2,Vector3F *param_3,int *param_4,int param_5);
void __cdecl lego::res::Struct2B0_FUN_0046fbe0(Struct_2b0 *param_1,float elapsed);
BOOL __cdecl lego::unk::Struct2B0_FUN_0046fdb0(LiveObject *liveObj,Vector3F *param_2,Vector3F *param_3,uint weaponType,uint param_5);
