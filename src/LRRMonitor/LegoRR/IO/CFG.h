// (CFGProperty.h : Declares LegoRR CFG configuration file functions and types
//
...
public:
	...
	/*14,4*/ const CFGProperty* next; // init: NULL
	/*18,4*/ const CFGProperty* previous;  // init: NULL (if root)
protected:
	/*1c,4*/ CFGProperty* pool_next;
...
public:
	...
	// 
	// <LegoRR.exe @00479120>
	static CFGProperty* __cdecl Open(const char* filename);
	...
	// <LegoRR.exe @004792b0>
	const CFGProperty* GetBlockFirstChild(const char* keyPath) const;
	...
	// <LegoRR.exe @004792e0>
	const CFGProperty* NextFlatProperty() const;
...
private:
	...
	// 
	// <LegoRR.exe @00479530>
	static CFGProperty* __cdecl CFG__Next(CFGProperty* previous);
public:
	...
	// 
	// <LegoRR.exe @004795a0>
	const CFGProperty* __cdecl GetProperty(const char* keyPath) const;
	...
	//static lego::pool::ReservedPool<CFGProperty, 32> Pool;
...
class CFG : CFGProperty
{
	...
	// 
	// <LegoRR.exe @00479120>
	static CFG* __cdecl Open(const char* filename);
