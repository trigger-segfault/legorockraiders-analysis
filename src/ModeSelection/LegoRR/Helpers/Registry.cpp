...
// <LegoRR.exe @0048b620>
BOOL __cdecl lego::registry::QueryValueOnLocalMachine(const char* subKey, const char* valueName, RegistryType valueType, void* out_buffer, unsigned int bufferSize)
{
...
// <CLGen.exe @00401690>
BOOL __cdecl lego::registry::SetValueOnLocalMachine(const char* subKey, const char* valueName, RegistryType valueType, const void* in_buffer, unsigned int bufferSize)
{
