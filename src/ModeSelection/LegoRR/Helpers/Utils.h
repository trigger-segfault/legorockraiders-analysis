...
// 
// Returns a duplicated string that must be freed.
// 
// <LegoRR.exe @00477850>
...
// Used to hash SFX names for lookup (only time hashing is used for strings?)
// <https://github.com/microsoft/Windows-classic-samples/blob/27ffb0811ca761741502feaefdb591aebf592193/Samples/Win7Samples/begin/sdkdiff/utils.cpp#L764>
// <LegoRR.exe @00477930>
unsigned int __cdecl hash_string(LPCSTR str, BOOL bIgnoreBlanks, BOOL bIgnoreCase);

// returns 0 or 1 on success, and 2 on failure
// 
// <LegoRR.exe @004779d0>
BOOL3 __cdecl parseBoolLiteral(const char* text);
